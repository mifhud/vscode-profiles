...
Write-Host "Windsurf Javascript"
...
Start-Process -FilePath "Windsurf" -ArgumentList "--profile=`"Javascript Lite`" --extensions-dir=`"D:\Program Files\.windsurf\extensions`"", "`"$DIRECTORY`"" -WindowStyle Hidden