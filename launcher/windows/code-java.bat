...
@REM code --profile "Java Lite" "%DIRECTORY%"
call code --profile "Java Lite" --extensions-dir="D:\Program Files\.vscode\extensions" --user-data-dir="D:\Program Files\.vscode\settings" "%DIRECTORY%" & exit
