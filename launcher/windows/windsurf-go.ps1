...
Start-Process -FilePath "Windsurf" -ArgumentList "--profile=`"Golang Lite`" --extensions-dir=`"D:\Program Files\.windsurf\extensions`"", "`"$DIRECTORY`"" -WindowStyle Hidden