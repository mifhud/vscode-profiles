...
Start-Process -FilePath "code" -ArgumentList "--profile=`"Java Lite`" --extensions-dir=`"D:\Program Files\.vscode\extensions`" --user-data-dir=`"D:\Program Files\.vscode\settings`"", "`"$DIRECTORY`"" -WindowStyle Hidden